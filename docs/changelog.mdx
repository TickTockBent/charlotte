...
description: New features, fixes, and the full versioned release history for Charlotte, the MCP server that renders web pages into structured, agent-readable representations.
