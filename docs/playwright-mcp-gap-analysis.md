...
| **Charlotte Status** | Not implemented — requires sequential `charlotte_type` calls for each field |
...
| **Charlotte Status** | Not implemented — `charlotte_type` fills the entire value at once |
...
|-----|---------------|-----------|
| GAP-04 | `charlotte_fill_form` | Reduces N tool calls to 1 for multi-field forms |
